...
Выбран вариант 2: **Школа**. Реализовано приложение для работы с таблицей students. Структура таблицы:
...
![Главный экран со списком животных](media/1.png)

**Рисунок 1** — Главный экран: список учеников

![Диалог добавления](media/2.png)

**Рисунок 2** — Диалог добавления нового ученика

![Диалог редактирования](media/3.png)

**Рисунок 3** — Диалог редактирования данных

![Подтверждение удаления](media/4.png)

**Рисунок 4** — Удаление записи по долгому нажатию
